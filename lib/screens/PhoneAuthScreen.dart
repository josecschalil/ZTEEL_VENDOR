...
// ── Design tokens ──────────────────────────────
const _bg = Color(0xFF16100A); // near-black warm brown
const _orange = Color(0xFFE87722);
const _orangeDim = Color(0xFF7A3D10);
const _white = Color(0xFFF5F0EB); // warm white
const _grey1 = Color(0xFF9E9080); // warm muted text
const _grey2 = Color(0xFF3A2E26); // subtle divider / hint
